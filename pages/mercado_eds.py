...
from Constants import style_data, style_cell, style_header, style_table, style_graph, \
    style_header1, style_header4, style_H3, style_text_bottom, style_H2, style_drop_label, verde, azul, gris
...
def update_market_map(sicom_code):
    ...
    competitor_lats = [comp['coords'][1] for comp in map_data['competitors']]
    competitor_lons = [comp['coords'][0] for comp in map_data['competitors']]
    competitor_texts = [
